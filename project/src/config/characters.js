...
function buildGenericUiConfig(columnValues, overrides = {}) {
  return {
    available_keys: overrides.available_keys ?? Object.keys(columnValues),
...
function createTableSchema({
  ...
  const uiConfig = buildGenericUiConfig(columnValues, ui)
  const inputConfig = {
